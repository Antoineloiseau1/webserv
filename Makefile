...
SRCS		= main.cpp utils.cpp ./Networking/Socket.cpp ./Networking/ListeningSocket.cpp Networking/Server.cpp Networking/Client.cpp\
			  parsing/parse_conf.cpp ./HTTP/Request.cpp ./HTTP/Response.cpp
